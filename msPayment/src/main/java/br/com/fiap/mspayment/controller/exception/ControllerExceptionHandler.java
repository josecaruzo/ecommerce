package br.com.fiap.mspayment.controller.exception;
...
public class ControllerExceptionHandler {
	...
	public ResponseEntity<StandardError> notReadableException(HttpMessageNotReadableException e, HttpServletRequest request){
		HttpStatus status = HttpStatus.BAD_REQUEST;

		newError.setTimestamp(Instant.now());
		newError.setStatus(status.value());
		newError.setError("JSON parse error."); // JSON parsing error
		newError.setMessage(e.getMessage());
		newError.setPath(request.getRequestURI());
